...
hour = 7;
if (hour > 12) {
  console.log("Good morning 🌞, it's time to make tea, shower, and eat breakfast!");
}
...
if (hour > 12) {
  ...
  console.log("Good afternoon ☁️, it's time to make tea, play with the dog, and do homework!");
